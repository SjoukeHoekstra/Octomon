...
#define BAG_TMHM_COUNT 30
#define BAG_BERRIES_COUNT 10
#define BAG_MEDICINE_COUNT 0
#define BAG_BATTLEITEMS_COUNT 38
#define BAG_POWERUP_COUNT 38
#define BAG_MAIL_COUNT 0
#define BAG_TREASURES_COUNT 0
#define BAG_MEGASTONES_COUNT 0
